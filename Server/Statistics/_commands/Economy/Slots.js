...
let Kıbrısramal = [message.guild.emojiGöster("ramal_pat"),message.guild.emojiGöster("ramal_heart"),message.guild.emojiGöster("ramal_vis")];
...
\`___SLOTS___\`
  ${message.guild.emojiGöster("ramal_slot")} ${message.guild.emojiGöster("ramal_slot")} ${message.guild.emojiGöster("ramal_slot")}
\`|         |\`
\`|         |\`
