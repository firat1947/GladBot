...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    let Row = new MessageActionRow().addComponents(
        ...
        .setStyle("SUCCESS")
        .setEmoji(message.guild.emojiGöster("ramal_giveaway")),
        new MessageButton()
    ...
    await load.edit({
        components: [Row],
        content: `${message.guild.emojiGöster("ramal_giveaway")} ${message.guild.emojiGöster("ramal_giveaway")} **ÇEKİLİŞ** ${message.guild.emojiGöster("ramal_giveaway")} ${message.guild.emojiGöster("ramal_giveaway")}`,
        embeds: [
